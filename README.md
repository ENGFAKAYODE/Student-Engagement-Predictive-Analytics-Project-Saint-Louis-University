...
|---|---|---|
| Time in Opportunity | Max = 45,630 hrs (~5.2 yrs) | Corrected after python was used to calculate it; NaN for never-started |
| Engagement Lag | Negative values (min = -570 hrs) | Applied absolute values to correct it |
